...
const PROTO_PATH = Assets.absoluteFilePath('qscbase.proto').split(
  'qscbase.proto'
)[0]
            ...
            fs.writeFile(qrlProtoFilePath, res.grpcProto, (fsErr) => {
              ...
              fs.readFile(qrlProtoFilePath, (errR, contents) => {
                ...
                if (
                  ...
                  protoloader
                    ...
                    .then((packageDefinition) => {
                      ...
                      if (verifiedObject === true || allowUnchecksummedNodes === true) {
                        ...
                        qrlClient[endpoint] = new grpcObject.qsc.PublicAPI(
                          endpoint,
                          grpc.credentials.createInsecure()
                        )
                        ...
                        console.log(
                          `Invalid qsc.proto grpc object shasum - node version: ${res.version}, qsc.proto object sha256: ${calculatedObjectHash}`
                        )
                  ...
                  // qsc.proto file shasum does not match verified known shasum
                  // Could be node acting in bad faith.
                  console.log(
                    `Invalid qsc.proto shasum - node version: ${res.version}, qsc.proto sha256: ${calculatedProtoHash}`
                  )
                  const myError = errorCallback(
                    err,
                    `Invalid qsc.proto shasum - node version: ${res.version}, qsc.proto sha256: ${calculatedProtoHash}`,
...
if (Meteor.isServer) {
  Meteor.startup(() => {
    console.log(`QSC Wallet Starting - Version: ${WALLET_VERSION}`)
